...
πρόγραμμα και όχι από τον χρήστη (για την i ενοικίαση θα δίνεται ως αριθμός ενοικίασης το i). Η αναλυτική
κατάσταση θα εμφανίζεται σε αριστερή στοίχιση. */
