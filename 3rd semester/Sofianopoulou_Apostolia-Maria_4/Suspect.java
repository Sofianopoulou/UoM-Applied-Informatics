...
public class Suspect {
	...
	private String town;
	private ArrayList<String> numbers = new ArrayList<String>(); //List of phone numbers that the suspects uses.
	private ArrayList<Suspect> possible_partners = new ArrayList<Suspect>();
	private ArrayList<Suspect> common_partners = new ArrayList<Suspect>();
	private ArrayList<Suspect> suggested_partners = new ArrayList<Suspect>();
	...
	public ArrayList<Suspect> getPossPartners() 
